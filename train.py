...
from preprocessing import idx2char
from config import *
...
parser.add_argument('--train_data', metavar='train_data', type=str, default="_all_data_ever", help='Which preprocessed training dataset to use.')
